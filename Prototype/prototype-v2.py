...
if st.session_state.vectorstore:
    ...
    if st.session_state.images:
        ...
        if selected_image:
            st.image(selected_image, caption=selected_image_choice, use_column_width=True)

        custom_query = st.text_area("Enter your custom query for the selected image:")

        if custom_query:
            with st.spinner("Querying LLaVA for image..."):
